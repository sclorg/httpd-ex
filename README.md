...
```
$ s2i build https://github.com/mriddl01/httpd-ex centos/httpd-24-centos7 myhttpdimage
...
`$ oc new-app centos/httpd-24-centos7~https://github.com/mriddl01/httpd-ex`

You can also deploy the sample template for the application:

`$ oc new-app -f https://raw.githubusercontent.com/mriddl01/httpd-ex/master/openshift/templates/httpd.json`
